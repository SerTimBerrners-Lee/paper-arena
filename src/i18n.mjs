...
const DICT = {
  en: {
    ...
    'reason.idle': 'Inactivity — you stopped building.',
    'reason.conquered': 'A rival conquered the whole arena.',
    'reason.default': 'Your run has ended.',
    'victory.title': 'VICTORY', 'victory.reason': 'You conquered the arena!',
    'hud.territory': 'Territory', 'hud.kills': 'Kills', 'hud.earned': 'Earned',
    'hud.cashout': 'CASH OUT', 'hud.menu': 'MENU', 'hud.loading': 'Loading…', 'hud.idleWarn': 'MOVE!!!',
    ...
    'topup.title': 'TOP UP', 'topup.soon': 'On-chain top-up is coming soon', 'topup.note': 'First via the TON blockchain, cards later.', 'ref.top': 'TOP REFERRERS',    'ref.copy': 'COPY LINK', 'ref.copied': 'Link copied!', 'ref.count': 'Invited', 'ref.earned': 'Ref. earned',
  ...
  ru: {
    ...
    'reason.idle': 'Бездействие — ты перестал строить.',
    'reason.conquered': 'Соперник захватил всю арену.',
    'reason.default': 'Твой забег окончен.',
    'victory.title': 'ПОБЕДА', 'victory.reason': 'Ты захватил всю арену!',
    'hud.territory': 'Территория', 'hud.kills': 'Киллы', 'hud.earned': 'Заработок',
    'hud.cashout': 'ЗАБРАТЬ', 'hud.menu': 'МЕНЮ', 'hud.loading': 'Загрузка…', 'hud.idleWarn': 'ДВИГАЙСЯ!!!',
    ...
    'topup.title': 'ПОПОЛНЕНИЕ', 'topup.soon': 'Пополнение скоро', 'topup.note': 'Сначала через блокчейн TON, позже — карты.', 'ref.top': 'ТОП РЕФЕРОВОДОВ',    'ref.copy': 'КОПИРОВАТЬ ССЫЛКУ', 'ref.copied': 'Ссылка скопирована!', 'ref.count': 'Приглашено', 'ref.earned': 'С рефералов',
  ...
  uk: {
    ...
    'reason.idle': 'Бездіяльність — ти перестав будувати.',
    'reason.conquered': 'Суперник захопив усю арену.',
    'reason.default': 'Твій забіг завершено.',
    'victory.title': 'ПЕРЕМОГА', 'victory.reason': 'Ти захопив усю арену!',
    'hud.territory': 'Територія', 'hud.kills': 'Вбивства', 'hud.earned': 'Заробіток',
    'hud.cashout': 'ЗАБРАТИ', 'hud.menu': 'МЕНЮ', 'hud.loading': 'Завантаження…', 'hud.idleWarn': 'РУХАЙСЯ!!!',
    ...
    'topup.title': 'ПОПОВНЕННЯ', 'topup.soon': 'Поповнення скоро', 'topup.note': 'Спершу через блокчейн TON, пізніше — картки.', 'ref.top': 'ТОП РЕФЕРАЛІВ',    'ref.copy': 'КОПІЮВАТИ ПОСИЛАННЯ', 'ref.copied': 'Посилання скопійовано!', 'ref.count': 'Запрошено', 'ref.earned': 'З рефералів',
