...
const DICT = {
  en: {
    ...
    'hud.cashout': 'CASH OUT', 'hud.menu': 'MENU', 'hud.loading': 'Loading…',
  ...
  ru: {
    ...
    'hud.cashout': 'ЗАБРАТЬ', 'hud.menu': 'МЕНЮ', 'hud.loading': 'Загрузка…',
  ...
  uk: {
    ...
    'hud.cashout': 'ЗАБРАТИ', 'hud.menu': 'МЕНЮ', 'hud.loading': 'Завантаження…',
