...
const DICT = {
  en: {
    ...
    'hud.cashout': 'CASH OUT', 'hud.menu': 'MENU', 'hud.loading': 'Loading…', 'hud.idleWarn': 'BUILD OR DIE',
  ...
  ru: {
    ...
    'hud.cashout': 'ЗАБРАТЬ', 'hud.menu': 'МЕНЮ', 'hud.loading': 'Загрузка…', 'hud.idleWarn': 'СТРОЙ ИЛИ УМРЁШЬ',
  ...
  uk: {
    ...
    'hud.cashout': 'ЗАБРАТИ', 'hud.menu': 'МЕНЮ', 'hud.loading': 'Завантаження…', 'hud.idleWarn': 'БУДУЙ АБО ПОМРЕШ',
